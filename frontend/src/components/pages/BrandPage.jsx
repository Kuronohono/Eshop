...
const BrandPage = () => {
    ...
    useEffect(() => {
        fetch(`http://localhost:8085/products/brands/${brandEnum}`)
            .then(res => res.json())
            .then(data => {
                setProducts(data)
                setLoading(false)
    ...
    const crumbs = useMemo(() => {
        const formattedBrand = brand ? String(brand).replace(/_/g, " ") : ""
        return [
            { label: "Home", to: "/home" },
            { label: "Brands", to: "/brands" },
            { label: formattedBrand, to: `/Brands/${brand}` },
        ]
    }, [brand])
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 2xl:grid-cols-5 gap-8 items-start justify-center">
                ...
                <div className="flex flex-col col-span-2 lg:col-span-3 2xl:col-span-3">
                    ...
                    <div className="flex gap-2 justify-between items-center ">
                        ...
                        <h1 className="page_header">{brand}</h1>
