...
const CardComponent = ({product}) => {
  return (
    <div className="flex flex-col gap-2 hover:scale-105 transition-all active:scale-100 cursor-pointer w-full">
        <img src={product?.img} alt="product" className=" w-full h-[200px] md:h-[300px] object-cover rounded-2xl bg-[#F0F0F0]"/>
                            <div className="flex flex-col gap-1">
                                <h3 className="font-satoshibold text-16px md:text-[20px] truncate">{product?.title}</h3>
