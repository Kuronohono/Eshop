...
const ProductPrice = ({price, sale_per}) => {
    ...
    if(sale_per == 0){
        ...
        price_div.push(<h3 className="font-satoshibold text-[24px]">${new_price}</h3>);
        price_div.push(<h3 className="font-satoshibold text-[24px] opacity-40 line-through">${price}</h3>)
